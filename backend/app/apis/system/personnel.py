...
# 人员信息相关接口
@router.post('/personnel/create', description="新增人员信息")
...
# 员工资质证书相关接口
@router.post('/personnel/qualification/create', description="新增员工资质证书")
...
@router.post('/personnel/qualification/update', description="更新员工资质证书")
...
@router.post('/personnel/qualification/delete', description="删除员工资质证书")
...
@router.post('/personnel/qualification/list', description="获取员工资质证书列表")
...
@router.post('/personnel/qualification/get', description="根据ID获取员工资质证书")
